...
DEVICE_PACKET_TYPE_HEARTBEAT: Final = 15

# In minutes
TIMEOUT_FOR_DEVICE_STATE_PACKETS: Final = 5

SYSTEM_INFO_MODEL: Final = 2
SYSTEM_INFO_HARDWARE_VERSION: Final = 8
SYSTEM_INFO_FIRMWARE_VERSION: Final = 9
SYSTEM_INFO_REGISTRATION_CODE: Final = 10
SYSTEM_INFO_INSTALLATION_NAME: Final = 11

SECTION_PRIMARY_STATE_DISARMED: Final = 1
SECTION_PRIMARY_STATE_ARMED_PARTIALLY: Final = 2
SECTION_PRIMARY_STATE_ARMED_FULL: Final = 3
SECTION_PRIMARY_STATE_SERVICE: Final = 5
SECTION_PRIMARY_STATE_BLOCKED: Final = 6
...
DEVICE_INFO_TYPE_POWER: Final = b"\x8a"
DEVICE_INFO_TYPE_SMOKE: Final = b"\x83"
DEVICE_INFO_TYPE_PULSE: Final = b"\x90"
DEVICE_INFO_TYPE_INPUT_VALUE: Final = b"\xae"
DEVICE_INFO_TYPE_INPUT_EXTENDED: Final = b"\x4f"
DEVICE_INFO_KNOWN_TYPES: Final = (
...
PG_OUTPUT_TURN_ON: Final = 1
PG_OUTPUT_TURN_OFF: Final = 2
