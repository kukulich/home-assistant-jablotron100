...
JABLOTRON_PACKETS_DEVICE_ACTIVITY = [b"\x00", b"\x01", b"\x24", b"\x3e", b"\x81", b"\xa3"]
JABLOTRON_PACKETS_DEVICE_SABOTAGE = [b"\x05", b"\x06", b"\x29", b"\x43", b"\x86", b"\xa8"]
JABLOTRON_PACKETS_DEVICE_FAULT = [b"\x07", b"\x08", b"\x2b", b"\x45", b"\x88", b"\xaa"]
