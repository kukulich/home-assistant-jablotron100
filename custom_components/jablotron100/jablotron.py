...
JABLOTRON_PACKETS_DEVICE_ACTIVITY = [b"\x00", b"\x01", b"\x0a", b"\x0c", b"\x24", b"\x3e", b"\x81", b"\xa3", b"\xa6", b"\xbe"]
JABLOTRON_PACKETS_DEVICE_SABOTAGE = [b"\x05", b"\x06", b"\x0f", b"\x11", b"\x29", b"\x43", b"\x86", b"\xa8", b"\xab", b"\xc3"]
JABLOTRON_PACKETS_DEVICE_FAULT = [b"\x07", b"\x08", b"\x11", b"\x13", b"\x2b", b"\x45", b"\x88", b"\xaa", b"\xad", b"\xc5"]
...
JABLOTRON_SECTION_PRIMARY_STATE_TRIGGERED = 17
