...
- Only devices with two states (on/off, active/inactive, open/closed etc.) are supported. No other types are currently supported (e.g. temperature of thermostat or smoke detector).
